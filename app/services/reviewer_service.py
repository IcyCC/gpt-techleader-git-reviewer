...
class ReviewerService:
    ...
    async def handle_comment(self, owner: str, repo: str, mr_id: str, comment_id: str) -> Comment:
        """处理评论回复"""
        # 获取 MR 信息
        mr = await self.git_client.get_merge_request(owner, repo, mr_id)
        # 获取原始评论
        original_comment = await self.git_client.get_comment(owner, repo, mr, comment_id)
        # 处理回复
